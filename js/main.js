...
loadBoundaryLayer(GEOJSON_BASE_PATH + "Division_outer.geojson", divisionLayer, "cyan", "Division_N", "Division Boundary");
loadBoundaryLayer(GEOJSON_BASE_PATH + "Range_Json.geojson", rangeLayer, "#2196F3", "Range_Name", "Range Boundary");
loadBoundaryLayer(GEOJSON_BASE_PATH + "Round_File.geojson", roundLayer, "#9C27B0", "Round_Name", "Round Boundary");
loadBoundaryLayer(GEOJSON_BASE_PATH + "Beat_Boundary.geojson", beatLayer, "#333", "Beat_Name", "Beat Boundary");
loadBoundaryLayer(GEOJSON_BASE_PATH + "Comparment_Modify1.geojson", compartmentLayer, "#F44336", "Old_ComptN", "Compartment Boundary");
loadBoundaryLayer(GEOJSON_BASE_PATH + "Village_file_1.geojson", villageLayer, "#FF9800", "Name", "Village Boundary");
loadBoundaryLayer(GEOJSON_BASE_PATH + "firewatchtower.geojson", firewatchtowerLayer, "#000", "Name", "Fire Watch Tower");
loadBoundaryLayer(GEOJSON_BASE_PATH + "Jogapur_Safari_Route.geojson", jogapursafariLayer, "#E91E63", "Name", "Jogapur Safari");
loadBoundaryLayer(GEOJSON_BASE_PATH + "karwa_Safari_Route_Demo.geojson", karwasafariLayer, "#E91E63", "Name", "karwa Safari");
loadBoundaryLayer(GEOJSON_BASE_PATH + "FDCM.geojson", fdcmLayer, "#795548", "FDCM", "FDCM Boundary", true);
loadBoundaryLayer(GEOJSON_BASE_PATH + "Kanhargaon WLS.geojson", kanhargaonWlsLayer, "#4CAF50", "Name", "Kanhargaon WLS");
loadBoundaryLayer(GEOJSON_BASE_PATH + "Stream_Network.geojson", streamNetworkLayer, "deepskyblue", "ORD_STRA", "Stream Network");

loadPointLayer(GEOJSON_BASE_PATH + "Waterbody_cc.geojson", waterbodyLayer, '<span>\uD83D\uDCA7</span>', "Attribute", "Waterbody", true);
loadPointLayer(GEOJSON_BASE_PATH + "Range office Headquarters.geojson", rangeofficeLayer, '<span>\uD83C\uDFDB\uFE0F</span>', "Attribute", "Range Office Headquarters", true);
loadPointLayer(GEOJSON_BASE_PATH + "Round_Office_Headquarters.sbx.geojson", roundofficeLayer, '<span>\uD83C\uDFE5</span>', "Attribute", "Round Office", true);
loadPointLayer(GEOJSON_BASE_PATH + "Rest House.geojson", restHouseLayer, '<span>\uD83C\uDFE8</span>', "Attribute", "Rest House", true);
...
function loadStaticLayer() {
  ...
  var staticMap = {
    "Soil_Depth": { layer: soilDepthLayer, file: GEOJSON_BASE_PATH + "Soil_Depth.geojson", color: "#f4a261", nameProp: "class", label: "Soil Depth", srcCrs: "EPSG:32643", fillOpacity: 0.5 },
    "Soil_Erosion": { layer: soilErosionLayer, file: GEOJSON_BASE_PATH + "Soil_Erosion.geojson", color: "#fd8d3c", nameProp: "descr", label: "Soil Erosion", srcCrs: "EPSG:32643", fillOpacity: 0.5 },
    "Soil_Slope": { layer: soilSlopeLayer, file: GEOJSON_BASE_PATH + "Soil_Slope.geojson", color: "#41b6c4", nameProp: "descr", label: "Soil Slope", srcCrs: "EPSG:32643", fillOpacity: 0.5 },
    "Soil_Productivity": { layer: soilProductivityLayer, file: GEOJSON_BASE_PATH + "Soil_Productivity.geojson", color: "#91cf60", nameProp: "prod_class", label: "Soil Productivity", srcCrs: "EPSG:32643", fillOpacity: 0.5 },
    "Soil_Texture": { layer: soilTextureLayer, file: GEOJSON_BASE_PATH + "Soil_Texture.geojson", color: "#74a9cf", nameProp: "descr", label: "Soil Texture", srcCrs: "EPSG:32643", fillOpacity: 0.5 }
  };
...
function loadPoiLayer() {
  ...
  if (val === 'streamNetwork' && streamNetworkLayer.getLayers().length === 0) {
    loadBoundaryLayer(GEOJSON_BASE_PATH + "Stream_Network.geojson", streamNetworkLayer, "deepskyblue", "ORD_STRA", "Stream Network", true, "EPSG:32644", 0.0, false);
  }
...
function loadOtherLayer() {
  ...
  if (val === 'fdcm' && fdcmLayer.getLayers().length === 0) {
    loadBoundaryLayer(GEOJSON_BASE_PATH + "FDCM.geojson", fdcmLayer, "#795548", "FDCM", "FDCM Boundary", true, "EPSG:32644", 0.0, false);
  }
  if (val === 'kanhargaon' && kanhargaonWlsLayer.getLayers().length === 0) {
    loadBoundaryLayer(GEOJSON_BASE_PATH + "Kanhargaon WLS.geojson", kanhargaonWlsLayer, "#4CAF50", "Name", "Kanhargaon WLS", true, "EPSG:32644", 0.0, false);
  }
...
function loadOfficeLayer() {
  ...
  if (val === 'rangeoffice' && rangeofficeLayer.getLayers().length === 0) {
    loadPointLayer(GEOJSON_BASE_PATH + "Range office Headquarters.geojson", rangeofficeLayer, '<span>🏢</span>', "Attribute", "Range Office Headquarters", true);
  }
...
function loadSafariLayer() {
  ...
  if (val === 'jogapur' && jogapursafariLayer.getLayers().length === 0) {
    loadBoundaryLayer(GEOJSON_BASE_PATH + "Jogapur_Safari_Route.geojson", jogapursafariLayer, "#E91E63", "Name", "Jogapur Safari", true, "EPSG:32644", 0.0, false);
  }
  if (val === 'karwa' && karwasafariLayer.getLayers().length === 0) {
    loadBoundaryLayer(GEOJSON_BASE_PATH + "karwa_Safari_Route_Demo.geojson", karwasafariLayer, "#E91E63", "Name", "Karwa Safari", true, "EPSG:32644", 0.0, false);
  }
...
function loadCoupe_plantationLayers() {
  ...
  var coupeMap = {
    "IWC": { layer: iwcLayer, file: GEOJSON_BASE_PATH + "IWC.geojson", color: "#1f77b4", nameProp: "Coupe_No", label: "IWC Plantation", srcCrs: "EPSG:32644", fillOpacity: 0.0 },
    "FWC": { layer: fwcLayer, file: GEOJSON_BASE_PATH + "FWC.geojson", color: "#ff7f0e", nameProp: "Coupe_No", label: "FWC Plantation", srcCrs: "EPSG:32644", fillOpacity: 0.0 },
    "SCI": { layer: sciLayer, file: GEOJSON_BASE_PATH + "SCI.geojson", color: "#2ca02c", nameProp: "Coupe_No", label: "SCI Plantation", srcCrs: "EPSG:32644", fillOpacity: 0.0 },
    "OTPL": { layer: otplLayer, file: GEOJSON_BASE_PATH + "OTPL.geojson", color: "#d62728", nameProp: "Coupe_No", label: "OTPL Plantation", srcCrs: "EPSG:32644", fillOpacity: 0.0 }
  };
  clearAllDropdownLayers();
  if (val && coupeMap[val]) {
...
function updateZoomIndicator() {
  ...
  setTimeout(function() { zoomIndicator.style.transform = 'scale(1)'; }, 200);
}
...
function showKbdHint() {
  ...
  kbdHintTimer = setTimeout(function() { kbdHint.classList.remove('visible'); }, 4000);
}
